...
from suite.datasets import AGENTIC_DATASETS, CODING_DATASETS, DATASET_LOADERS, QA_DATASETS
...
def main() -> None:
    ...
    parser.add_argument(
        "--dataset",
        type=str,
        choices=list(DATASET_LOADERS.keys()) + ["all", "agentic", "qa", "coding"],
        default="all",
    ...
    if args.dataset == "all":
        ...
        datasets_to_run = CODING_DATASETS
    else:
