...
def _get_headroom():
    """Get or initialize the real Headroom SmartCrusher + ToolCrusher."""
    global _headroom_smart, _headroom_tool
    if _headroom_smart is None:
        from headroom import SmartCrusher, SmartCrusherConfig, ToolCrusher, ToolCrusherConfig

        _headroom_smart = SmartCrusher(SmartCrusherConfig(min_tokens_to_crush=50))
        _headroom_tool = ToolCrusher(ToolCrusherConfig(
            enabled=True,
    ...
    return _headroom_smart, _headroom_tool
